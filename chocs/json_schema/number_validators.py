...
from .errors import MaximumExclusiveRangeError
from .errors import MaximumRangeError
from .errors import MinimumExclusiveRangeError
from .errors import MinimumRangeError
from .errors import MultipleOfValidationError
...
def validate_multiple_of(value: Number, multiple_of: Number) -> Number:
    if not value % multiple_of == 0:
        raise MultipleOfValidationError(
...
def validate_exclusive_minimum(value: Number, expected_minimum: Number) -> Number:
    ...
    raise MinimumExclusiveRangeError(
        expected_minimum=expected_minimum
    )

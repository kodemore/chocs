...
@pytest.mark.parametrize("given_string, given_format, expected_value", [
    ...
    ["20201220T121314", StringFormat.DATE_TIME, datetime(year=2020, month=12, day=20, hour=12, minute=13, second=14)],
    ...
    ["1200:0000:AB00:1234:0000:2552:7777:1313", StringFormat.IP_ADDRESS, IPv6Address("1200:0000:AB00:1234:0000:2552:7777:1313")],
    ["21DA:D3:0:2F3B:2AA:FF:FE28:9C5A", StringFormat.IP_ADDRESS, IPv6Address("21DA:D3:0:2F3B:2AA:FF:FE28:9C5A")],

    ["0.0.0.0", StringFormat.IP_ADDRESS_V4, IPv4Address("0.0.0.0")],
    ["127.0.0.1", StringFormat.IP_ADDRESS_V4, IPv4Address("127.0.0.1")],

    ["1200:0000:AB00:1234:0000:2552:7777:1313", StringFormat.IP_ADDRESS_V6, IPv6Address("1200:0000:AB00:1234:0000:2552:7777:1313")],
    ["21DA:D3:0:2F3B:2AA:FF:FE28:9C5A", StringFormat.IP_ADDRESS_V6, IPv6Address("21DA:D3:0:2F3B:2AA:FF:FE28:9C5A")],
    ...
    ["cff801a5-5db7-4287-9414-64ba51a9a730", StringFormat.UUID, UUID("cff801a5-5db7-4287-9414-64ba51a9a730")],
    ["ad047288-b643-4cd0-8c79-354f68140bef", StringFormat.UUID, UUID("ad047288-b643-4cd0-8c79-354f68140bef")],
    ["b11b1836-ad3e-4944-9c80-eaccdac0487b", StringFormat.UUID, UUID("b11b1836-ad3e-4944-9c80-eaccdac0487b")],
    ["e643c4f2-f9c1-4287-b465-1e02ba7d902d", StringFormat.UUID, UUID("e643c4f2-f9c1-4287-b465-1e02ba7d902d")],
    ["57766d9b-9ea2-4740-9b26-56dfdd79678a", StringFormat.UUID, UUID("57766d9b-9ea2-4740-9b26-56dfdd79678a")],
])
...
@pytest.mark.parametrize("given_string, given_format", [
